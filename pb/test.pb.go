...
type IP struct {
	...
	Address              string   `protobuf:"bytes,1,opt,name=Address,proto3" json:"overrided" validate:"ip" yaml:"ip"`
...
type URL struct {
	...
	Scheme string `protobuf:"bytes,1,opt,name=scheme,proto3" json:"scheme,omitempty" validate:"http|https"`
	Url    string `protobuf:"bytes,2,opt,name=url,proto3" json:"url,omitempty"`
	// @inject_tag: validate:"nonzero"
	Port                 int32    `protobuf:"varint,3,opt,name=port,proto3" json:"port,omitempty" validate:"nonzero"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
